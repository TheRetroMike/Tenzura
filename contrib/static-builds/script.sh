...
find ${DISTNAME}/bin -type f -executable -exec ../tenzura/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../tenzura/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/tenzura/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/tenzura/depends/SDKs/MacOSX10.11.sdk.tar.gz
