...
2.  Build tenzura-core:
    ...
    Configure and build the headless tenzura binaries as well as the GUI (if Qt is found).
...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Tenzura Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Tenzura"

touch "/Users/${USER}/Library/Application Support/Tenzura/tenzura.conf"
...
```shell
tail -f $HOME/Library/Application\ Support/Tenzura/debug.log
```
...
------------------------
You can use Qt Creator as an IDE, for tenzura development.
...
4. Enter "tenzura-qt" as project name, enter src/qt as location
