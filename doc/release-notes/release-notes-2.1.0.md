Tenzura Core version *2.1.0* is now available!!
==============

  <https://github.com/Tenzura/Tenzura/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/Tenzura/Tenzura/commits/release_2.1.0>
