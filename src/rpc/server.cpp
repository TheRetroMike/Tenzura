...
CAmount AmountFromValue(const UniValue& value, bool p_isTENZ)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Tenzura server stopping";
}
...
{
    return "> tenzura-cli " + methodname + " " + args + "\n";
}
