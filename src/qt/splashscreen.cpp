    ...
    : QWidget(), curAlignment(0)
{
    ...
    QString copyrightText   = QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2025, COPYRIGHT_YEAR)).c_str());
    ...
    // draw the tenzura icon, expected size of PNG: 1024x1024
