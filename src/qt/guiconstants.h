...
#ifndef TENZURA_QT_GUICONSTANTS_H
#define TENZURA_QT_GUICONSTANTS_H
...
/* TenzuraGUI -- Size of icons in status bar */
...
/* Tenzura shadow color - light mode */
...
/* Tenzura label color as a string */
...
#define QAPP_ORG_NAME "Tenzura"
#define QAPP_ORG_DOMAIN "tenzura.org"
#define QAPP_APP_NAME_DEFAULT "Tenzura-Qt"
#define QAPP_APP_NAME_TESTNET "Tenzura-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.tenzura.io/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // TENZURA_QT_GUICONSTANTS_H
